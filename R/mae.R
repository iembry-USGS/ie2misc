...
#'
#' This function computes the mean absolute error (MAE), which is expressed as
#'
#' (MAE) is expressed as
#'
...
#' @encoding UTF-8
#'
#' @keywords mean absolute error MAE
#'
#'
#' @seealso \code{\link{mape}}, \code{\link{vnse}}, \code{\link{madstat}}, \code{\link{dr}}, \code{\link{rmse}}
#'
#'
#'
#' @examples
