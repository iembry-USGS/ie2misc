...
#'	\item pracma interp1 function definition - R package pracma created and maintained by Hans Werner Borchers. See \url{http://cran.r-project.org/web/packages/pracma/}.
#' }
#'
#' @encoding UTF-8
#'
